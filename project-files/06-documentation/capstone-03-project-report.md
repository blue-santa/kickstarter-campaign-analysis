...
The final output will include a collection of Jupyter Notebook .ipynb files, data-visualization images, a project-report pdf, and a slide presentation. At a future data, the project may expand to include a final outputted network-analysis visualization.

## Stakeholders

This project targets small-business owners that wish to use modern crowdsourcing tools to complete and profit by the means of individual campaigns. The presentation will be made availabe on the project author's personal website, [https://bluesanta.io](https://bluesanta.io).
...
This project is constrained to the data that is publicly available in the Web Robots archive. The archive contains various incomplete cross-sections of the entirety of Kickstarter histroy. Each dataset is nearly 1GB in size, and there are dozens of datasets. The project will only take one such cross-section for analysis. If a future research is interested to create a more complete collection, they can in theory download each of the archives and synthesize them together. 
...
The primary dataset for this project is the Web Robots Kickstarter archive:
...
The initial download file was over `700MB`, making it cumbersome on a consumer-grade desktop computer. After processing the initial download, converting it to `.csv`, and then finally to a parquet file at the completion of this stage, the final parquet file was less than `100MB`.
...
![Common Words in Kickstarter Project Descriptions](../03-exploratory-data-analysis/eda-data-visualizations/02-00-data-vis-wordcloud.png)
...
![Goal Amount vs. Pledge Amount](../03-exploratory-data-analysis/eda-data-visualizations/02-01-goal-vs-pledge-comparison.png)
...
![Campaign Count by Country](../03-exploratory-data-analysis/eda-data-visualizations/02-02-campaign-count-by-country.png)
...
![Mean Non-USD Pledged Amount by Country - Excluding USD-based Countries](../03-exploratory-data-analysis/eda-data-visualizations/02-03-mean-usd-pledged-amount-by-country-excluding-us.png)
...
![Pledged Amounts in Hong Kong](../03-exploratory-data-analysis/eda-data-visualizations/02-04-pledged-amounts-in-hong-kong.png)
...
![Average Pledge Amounts Per Project (Converted to $USD)](../03-exploratory-data-analysis/eda-data-visualizations/02-05-avg-pledge-amounts-per-project.png)
...
![Aggregate Pledge Amounts Over Time](../03-exploratory-data-analysis/eda-data-visualizations/02-06-agg-pledge-amounts.png)
...
![Aggregate Pledge Amounts Over Time (Successful Campaigns)](../03-exploratory-data-analysis/eda-data-visualizations/02-07-aggregate-pledge-amounts-successful-campaigns.png)
...
![Percent of Campaigns That Are Successful (Accuracy May Be Limited)](../03-exploratory-data-analysis/eda-data-visualizations/02-08-percent-campaigns-successful.png)
...
![Percent of Staff Pick Campaigns That Are Successful](../03-exploratory-data-analysis/eda-data-visualizations/02-09-percent-successful-staff-picks-only.png)
...
![Avg Backers vs. Pledge Size](../03-exploratory-data-analysis/eda-data-visualizations/02-10-backer-count-vs-pledge-amt.png)
...
![Percent Funded by Country](../03-exploratory-data-analysis/eda-data-visualizations/02-12-avg-prct-funded-by-country.png)
...
![Amount Pledge by Category](../03-exploratory-data-analysis/eda-data-visualizations/02-13-total-amount-pledged-by-category.png)
